...
- スプレッドシート風の「画面全体に広がる」プレビューに寄せるため、印刷プレビューを全画面オーバーレイ化し、プレビュー領域と設定フォームが高さいっぱいに並ぶようにしました。
- 用紙サイズは Letter/Tabloid/Legal/Statement/Executive/Folio/A3/A4/A5/B4/B5/Custom を用意し、Custom は mm 単位の数値入力（10 〜 2000mm）とページ向きでの縦横切り替えに対応します。
