export function queryDom() {
  return {
    ...
    participantsContextCard: document.getElementById("participants-context-callout"),
    participantsContextEvent: document.getElementById("participants-context-event"),
    participantsContextSchedule: document.getElementById("participants-context-schedule"),
    participantsContextRangeRow: document.getElementById("participants-context-range-row"),
    participantsContextRange: document.getElementById("participants-context-range"),
