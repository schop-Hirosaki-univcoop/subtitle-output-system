...
export function queryDom() {
  return {
    ...
    glFacultyLibraryName: document.getElementById("gl-faculty-library-name"),
    glOpenFacultyLibraryButton: document.getElementById("gl-open-faculty-library"),
    glTeamCountInput: document.getElementById("gl-team-count"),
    glTeamPreview: document.getElementById("gl-team-preview"),
    ...
    glFacultyStatus: document.getElementById("gl-faculty-status"),
    glFacultyList: document.getElementById("gl-faculty-list"),
    glFacultyEmpty: document.getElementById("gl-faculty-empty"),
    glFacultyAddButton: document.getElementById("gl-faculty-add-button"),
    glFacultySaveButton: document.getElementById("gl-faculty-save-button"),
    glFacultyLoadingOverlay: document.getElementById("gl-faculty-loading-overlay"),
    glFacultyCardTemplate: document.getElementById("gl-faculty-card-template"),
