export function queryDom() {
  return {
    ...
    sidebarCollapseButton: document.getElementById("flow-sidebar-collapse"),
    sidebarExpandButton: document.getElementById("flow-sidebar-expand"),
    sidebarResizer: document.getElementById("flow-stage-resizer"),
    sidebarOverlay: document.getElementById("flow-sidebar-overlay"),
    sidebarOverlayBackdrop: document.querySelector("[data-sidebar-overlay-dismiss]"),
    sidebarOverlayContent: document.getElementById("flow-sidebar-overlay-content"),
