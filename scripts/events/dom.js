export function queryDom() {
  return {
    ...
    navEventsButton: document.getElementById("flow-nav-events"),
    navSchedulesButton: document.getElementById("flow-nav-schedules"),
    ...
    dictionaryTab: document.getElementById("flow-tab-dictionary"),
    logsTab: document.getElementById("flow-tab-logs"),
