...
export function queryDom() {
  return {
    ...
    glSlugInput: document.getElementById("gl-link-slug"),
    glSlugPreview: document.getElementById("gl-link-slug-preview"),
    glPeriodStartInput: document.getElementById("gl-period-start"),
    glPeriodEndInput: document.getElementById("gl-period-end"),
    glFacultyConfigInput: document.getElementById("gl-faculty-config"),
    glTeamConfigInput: document.getElementById("gl-team-config"),
