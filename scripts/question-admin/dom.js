...
const dom = {
  ...
  printCustomSizeField: resolve("print-custom-size"),
  printCustomWidthInput: resolve("print-custom-width"),
  printCustomHeightInput: resolve("print-custom-height"),
...
dom.addParticipantDialog = resolve("add-participant-dialog");
dom.addParticipantDialogTitle = resolve("add-participant-dialog-title");
dom.addParticipantForm = resolve("add-participant-form");
dom.addParticipantCsvForm = resolve("add-participant-csv-form");
dom.addParticipantTabList = resolve("add-participant-tablist");
dom.addParticipantTabManual = resolve("add-participant-tab-manual");
dom.addParticipantTabCsv = resolve("add-participant-tab-csv");
dom.addParticipantTabpanelManual = resolve("add-participant-tabpanel-manual");
dom.addParticipantTabpanelCsv = resolve("add-participant-tabpanel-csv");
dom.addParticipantNameInput = resolve("add-participant-name-input");
dom.addParticipantPhoneticInput = resolve("add-participant-phonetic-input");
dom.addParticipantGenderInput = resolve("add-participant-gender-input");
dom.addParticipantDepartmentInput = resolve("add-participant-department-input");
dom.addParticipantTeamInput = resolve("add-participant-team-input");
dom.addParticipantPhoneInput = resolve("add-participant-phone-input");
dom.addParticipantEmailInput = resolve("add-participant-email-input");
dom.addParticipantError = resolve("add-participant-error");
dom.addParticipantCsvInput = resolve("add-participant-csv-input");
dom.addParticipantFileLabel = resolve("add-participant-file-label");
dom.addParticipantCsvError = resolve("add-participant-csv-error");
dom.addParticipantDownloadTemplate = resolve("add-participant-download-template");
dom.addParticipantSubmitButton = resolve("add-participant-submit-button");
dom.addParticipantButton = resolve("add-participant-button");
