...
export function queryDom() {
  return {
    ...
    exportScopeSelect: resolve("export-scope"),
    exportCsvUnansweredButton: resolve("export-csv-unanswered"),
    exportCsvAnsweredButton: resolve("export-csv-answered"),
    ...
    sideTelopAddButton: resolve("side-telop-add"),
    sideTelopEditButton: resolve("side-telop-edit"),
    sideTelopDeleteButton: resolve("side-telop-delete"),
    sideTelopSelectionLabel: resolve("side-telop-selection-label"),
    sideTelopDialog: resolve("side-telop-dialog"),
    sideTelopDialogForm: resolve("side-telop-dialog-form"),
    sideTelopDialogTitle: resolve("side-telop-dialog-title"),
    sideTelopDialogText: resolve("side-telop-dialog-text"),
    sideTelopDialogSubmit: resolve("side-telop-dialog-submit"),
    sideTelopDialogCancel: resolve("side-telop-dialog-cancel"),
    sideTelopDialogError: resolve("side-telop-dialog-error"),
